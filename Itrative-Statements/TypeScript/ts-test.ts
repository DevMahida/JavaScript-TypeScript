...
// revser number
let q1_v1: number = 2354;
let rev_num_q1: number = 0;
...
// revser number
let q2_v1: number = 232;
let rev_num_q2: number = 0;
let pal: number = q2_v1;
...
let q2Pal = document.getElementById("q2Pal") as HTMLElement;
...
//Armstrong number
let q8_v1:number = 153;
let temp:number = q8_v1;
let sum_8:number = 0;
...
let q8des = document.getElementById("q8des")as HTMLElement;
